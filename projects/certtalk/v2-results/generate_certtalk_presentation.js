...
async function generatePresentation() {
  console.log('CertTalk Presentation Generator v2 (with preliminary results)');
  console.log('==============================================================\n');
  ...
  // Save presentation
  const outputFile = 'CertTalk_Presentation_v2.pptx';
  console.log(`\nSaving presentation to: ${outputFile}`);

  await pptx.writeFile({ fileName: outputFile });

  console.log('\n✓ Presentation v2 generated successfully!');
